...
mixin _$Node {
  ...
  @OffsetConverter()
  Offset? get pos => throw _privateConstructorUsedError;
...
class _$NodeImpl implements _Node {
  ...
  @override
  String toString() {
    return 'Node(id: $id, label: $label, createdAt: $createdAt, pos: $pos)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, label, createdAt, pos);
...
abstract class _Node implements Node {
  const factory _Node({
    ...
    @OffsetConverter() final Offset? pos,
  }) = _$NodeImpl;
